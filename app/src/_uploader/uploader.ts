...
let logReader = new LogReader({logpath: filepath, timeBetweenLinesMS:1, startAtLineContaining:'Received GameFound'});
  ...
  packetQueue.push(
    async()=>{
      if(game){
        ...
        // console.log('Slot', spawn_player.Slot, 'SpawnPlayer:', {
        //   ...game.game_players,
